...
Public Class FrmModeloAcc
    Dim cl_m_a As New CL_MARCA_ACCESORIO
    Dim CL_MO_AC As New Cl_Modelo_Accesorio
    Dim cl_cmp As New Cl_componentes
    Private Sub FrmModeloAcc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        llenardependencia()
    ...
    Private Sub RadioButton2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadioButton2.Click
        Me.lblcodigomodelo.ResetText()
        FrmBuscarModeloAcc.Label2.Text = "0"

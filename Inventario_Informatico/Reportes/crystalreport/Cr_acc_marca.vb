...
Public Class Cr_acc_marca
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_acc_marca.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_acc_marca
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_acc_marca = New Cr_acc_marca
        rpt.Site = Me.Site
        Return rpt
    End Function

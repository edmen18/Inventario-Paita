...
Public Class Cr_accesorio_acc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_accesorio_acc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_accesorio_acc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_accesorio_acc = New Cr_accesorio_acc
        rpt.Site = Me.Site
        Return rpt
    End Function

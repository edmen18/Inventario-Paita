...
Public Class Cr_trasladodetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_trasladodetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_trasladodetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_trasladodetalle = New Cr_trasladodetalle
        rpt.Site = Me.Site
        Return rpt
    End Function

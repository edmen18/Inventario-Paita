...
Public Class Cr_accesorio_area
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_accesorio_area.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_accesorio_area
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_accesorio_area = New Cr_accesorio_area
        rpt.Site = Me.Site
        Return rpt
    End Function

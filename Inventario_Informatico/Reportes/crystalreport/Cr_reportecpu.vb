...
Public Class Cr_reportecpu
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_reportecpu.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_reportecpu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_reportecpu = New Cr_reportecpu
        rpt.Site = Me.Site
        Return rpt
    End Function

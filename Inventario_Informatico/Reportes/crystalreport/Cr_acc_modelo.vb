...
Public Class Cr_acc_modelo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_acc_modelo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_acc_modelo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_acc_modelo = New Cr_acc_modelo
        rpt.Site = Me.Site
        Return rpt
    End Function

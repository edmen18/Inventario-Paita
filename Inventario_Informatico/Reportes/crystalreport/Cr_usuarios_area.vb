...
Public Class Cr_usuarios_area
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_usuarios_area.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_usuarios_area
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_usuarios_area = New Cr_usuarios_area
        rpt.Site = Me.Site
        Return rpt
    End Function

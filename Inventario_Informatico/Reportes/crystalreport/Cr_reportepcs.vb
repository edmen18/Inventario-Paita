...
Public Class Cr_reportepcs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_reportepcs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_reportepcs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_reportepcs = New Cr_reportepcs
        rpt.Site = Me.Site
        Return rpt
    End Function

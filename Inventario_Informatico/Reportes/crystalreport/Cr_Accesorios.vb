...
Public Class Cr_Accesorios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_Accesorios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Accesorios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Accesorios = New Cr_Accesorios
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class Cr_traslados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventario_Informatico.Cr_traslados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_traslados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_traslados = New Cr_traslados
        rpt.Site = Me.Site
        Return rpt
    End Function
